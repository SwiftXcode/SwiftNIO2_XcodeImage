...
lint-templates :
	$(XML_LINTER) $(PROJECT_SERVER_TEMPLATES_DIR)/Swift\ NIO\ 2.xctemplate/TemplateInfo.plist
...
install-project-server-templates : uninstall-project-server-templates
	...
	$(INSTALL_R) \
		$(PROJECT_SERVER_TEMPLATES_DIR)/Swift\ NIO\ 2.xctemplate \
		$(XCODE_TEMPLATE_PROJECT_SERVER_SOURCE_DIR)/

uninstall-project-server-templates :
	$(UNINSTALL_R) \
		$(XCODE_TEMPLATE_PROJECT_SERVER_SOURCE_DIR)/Swift\ NIO\ 2.xctemplate
